      subroutine dqagpec(f,a,b,npts2,points,epsabs,epsrel,limit,result,
...
c
   40 resabs = 0.0d+00
      do 50 i = 1,nint
        b1 = pts(i+1)
        call dqk21c(f,a1,b1,area1,error1,defabs,resa)
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dqk21c(f,a1,b1,area1,error1,resa,defab1)
        call dqk21c(f,a2,b2,area2,error2,resa,defab2)
c
...
c
  110   call dqpsrtc(limit,last,maxerr,errmax,elist,iord,nrmax)
